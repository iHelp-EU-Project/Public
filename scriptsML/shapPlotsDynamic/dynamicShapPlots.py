...
def summary_plot_plotly_fig(dataset, target='target column', max_display = 50):
    # print(dataset)
    data = dataset #pd.read_csv( dataset, encoding="ISO-8859-1")
    ...
    mpl_fig = shap_summary_plot(shap_values, pd.DataFrame(X_train, columns=X.columns), feature_names=feature_names, max_display=50)
