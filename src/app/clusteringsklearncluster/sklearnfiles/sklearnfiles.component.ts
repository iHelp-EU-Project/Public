...
@Component({
  selector: 'app-sklearnfiles',
  templateUrl: './sklearnfiles.component.html',
  styleUrls: ['./sklearnfiles.component.css']
})
export class SklearnfilesComponent implements OnInit{
