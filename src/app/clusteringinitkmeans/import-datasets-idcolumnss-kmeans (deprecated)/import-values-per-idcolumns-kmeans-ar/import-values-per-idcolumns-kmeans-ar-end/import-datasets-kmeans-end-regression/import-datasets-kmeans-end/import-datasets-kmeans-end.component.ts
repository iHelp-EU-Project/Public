...
export class ImportDatasetsKmeansEndComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   runningScriptsMLKmeansEnd(): void {
      ...
      this.http.get(`http://127.0.0.1:5002/importDatasetsKmeans_End/${this.modelName}/${this.uploadedFilesTrain[0].name}/${this.selIds}/${this.selectedIdsRows}/${this.selectedIdsRowsSecondworkflow}/${this.selectedIdsRowsSecondworkflowEnd}/${this.currentUser.username}`).subscribe(data => {
