...
export class ImportValuesPerIDColumnsKmeansAREndComponent implements OnInit {
  ...
  saveColumnsIDstring(id): string {
   ...
   runningScriptsMLKmeansID_END(): void {
      ...
      this.http.get(`http://127.0.0.1:5002/importValuesPerIDColumnsKmeansAR_End/${this.modelName}/${this.uploadedFilesTrain[0].name}/Tabber-Stringer/${this.selIds}/${this.selectedIdsRows}/${this.selectedIdsRowsSecondworkflow}/${this.currentUser.username}`).subscribe(data => {
