...
export class ImportDatasetsKmeansEndRegressionComponent {
  ...
  constructor(private http: HttpClient,
   ...
   runningScriptsMLKmeansID_Regression(): void {
      ...
      try {
          ...
          this.http.get(`http://${this.host}:5002/importDatasetsKmeans_End_Regression/${this.modelName}/${this.uploadedFilesTrain[0].name}/${this.selIds}/${this.selectedIdsRows}/${this.selectedIdsRowsSecondworkflow}/${this.selectedIdsRowsSecondworkflowEnd}/${this.currentUser.username}`).subscribe(data => {
