...
@Component({
  selector: 'app-uploadfileskmeans',
  templateUrl: './uploadfileskmeans.component.html',
  styleUrls: ['./uploadfileskmeans.component.css']
})
export class UploadfileskmeansComponent implements OnInit {
