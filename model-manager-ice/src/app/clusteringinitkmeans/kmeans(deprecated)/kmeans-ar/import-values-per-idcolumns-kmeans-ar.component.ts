...
export class ImportValuesPerIDColumnsKmeansARComponent {
  ...
  saveColumnsIDstring(id): string {
   ...
   runningScriptsMLKmeansID(): void {
      ...
      try {
          ...
          this.http.get(`http://${this.host}:5002/importValuesPerIDColumnsKmeansAR/${this.modelName}/${this.uploadedFilesTrain[0].name}/Tabber-Stringer/${this.selIds}/${this.selectedIdsRows}/${this.currentUser.username}`).subscribe(data => {
