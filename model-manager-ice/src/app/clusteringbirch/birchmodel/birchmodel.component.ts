...
@Component({
  selector: 'app-birchmodel',
  templateUrl: './birchmodel.component.html',
  styleUrls: ['./birchmodel.component.css']
})
export class BirchmodelComponent implements OnInit, AfterViewInit{
  ...
  async ngOnInit() {
    ...
    this.reactiveForm = this.builder.group({
      ...
      branchingFactor: [null, Validators.required],
      computeLabels: [null, Validators.required],
  ...
  runningScriptsMLKmeansEnd(): void {
    ...
    setTimeout(() => {
      ...
      try {
        // tslint:disable-next-line: max-line-length
        return this.http.get(`/scripts/ScriptsBirch/${this.modelName}/${this.currentUser.username}/${this.correlationTrainName}/${this.clusterK}/${this.choseDeleteColumnsString}/${this.classColumn}/${this.columnsPredict}/${this.getNameClases()}/${this.threshold}/${this.branchingFactor}/${this.computeLabels}/${this.valuesNan}/${this.advancedModel}`, { responseType: 'text' }).subscribe(data => {
