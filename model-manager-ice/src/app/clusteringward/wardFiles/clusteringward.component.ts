...
@Component({
  selector: 'app-clusteringward',
  templateUrl: './clusteringward.component.html',
  styleUrls: ['./clusteringward.component.css']
})
export class ClusteringwardComponent implements OnInit{
