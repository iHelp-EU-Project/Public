...
import eu.ihelp.store.server.exceptions.TomcatGenericException;
import eu.ihelp.store.server.utils.TomcatServerProperties;
import eu.ihelp.store.services.resources.JerseyConfiguration;
import eu.ihelp.store.services.resources.conf.SimpleCORSFilter;
import java.io.File;
 ...
 */
public class IhelpStoreServerHandler extends Thread {
    private static final Logger log = LoggerFactory.getLogger(IhelpStoreServerHandler.class);
    ...
    public IhelpStoreServerHandler(int port, String swaggerWebAppBase) throws TomcatGenericException {
        ...
        TomcatServerProperties.getInstance();
        
        try {
             this.tomcat = new Tomcat();
            
             if(TomcatServerProperties.getInstance().isTomcatHttps()) {
                this.tomcat.getService().addConnector(getSslConnector(TomcatServerProperties.getInstance().getTomcatKeyStorePath(), port));
             }
