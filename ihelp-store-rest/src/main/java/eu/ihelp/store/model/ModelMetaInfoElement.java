...
public class ModelMetaInfoElement implements Serializable {
    ...
    public ModelMetaInfoElement(int modelID, String name, String snomed, boolean multipleValues, List<Object> possibleValues, List<Object> realValues, HashMap<Object, Object> mappedValues) {
    ...
    public String toString() {
        return "ModelMetaInfo{" + "modelID=" + modelID + ", name=" + name + ", snomed=" + snomed + '}';
    }
